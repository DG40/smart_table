...
def create_lum_sensors(address_1=0x23, address_2=0x5C):
    import smbus
    bus = smbus.SMBus(1)  # Rev 2 Pi uses 1
    sensor_1 = BH1750(bus, address_1)
    sensor_2 = BH1750(bus, address_2)
    return sensor_1, sensor_2


def light_level(*sensors):
    answer = []
    for sensor in sensors:
        answer.append(int(sensor.measure_low_res()))
    return answer
